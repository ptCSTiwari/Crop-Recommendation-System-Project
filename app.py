...
scaler = joblib.load(open("scaler.lb","rb"))
kmeans = joblib.load(open("crop_reco_kmeans.lb","rb"))
df = joblib.load(open("crop_reco_df.lb","rb"))
...
def predict():
  if request.method == "POST":
    ...
    ph = int(request.form["rainfall"])
    r = int(request.form["ph"])
